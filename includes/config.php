...
define('UPLOAD_MAX_SIZE', 20971520); //20 M
...
//Mode débug
// Ce mode débug n'a du sens que si display_errors=off dans php.ini
...
ini_set('upload_max_filesize', '20M'); 	//La taille maximale en octets d'un fichier à charger.
